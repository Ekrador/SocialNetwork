...
namespace SocialNetwork.DAL.Repositories
{
    public class FriendRepository : BaseRepository, IFriendRepository
    {
        ...
        public IEnumerable<FriendEntity> FindUserIdInFriendLists(int userId)
        {
            return Query<FriendEntity>(@"select * from friends where friend_id = :user_id", new { user_id = userId });
        }
    ...
    public interface IFriendRepository
    {
        ...
        IEnumerable<FriendEntity> FindUserIdInFriendLists(int userId);
        int Delete(int id);
    }
}
